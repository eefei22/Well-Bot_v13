...
class DeepgramSTTTester:
    ...
    def __init__(self, max_attempts: int = 1, sample_audio_path: str = None, debug: bool = False):
        ...
        self.log_file = self.test_output_dir / "stt.log"
...
with wave.open(str(self.sample_audio_path), 'rb') as wav_file:
    ...
    def test_health_endpoints(self) -> bool:
        ...
        try:
            ...
            # Save readiness data
            with open(self.test_output_dir / "stt_health.json", "w") as f:
    ...
    async def test_stt_websocket(self) -> bool:
        ...
        try:
            ...
            async with websockets.connect(self.stt_ws_endpoint) as websocket:
                ...
                with open(self.test_output_dir / "stt_result.json", "w") as f:
    ...
    def generate_report(self) -> None:
        ...
        report_path = self.test_output_dir / "stt_report.txt"
        
        # Load transcript data
        transcript_path = self.test_output_dir / "stt_result.json"
        ...
        with open(report_path, "w", encoding="utf-8") as f:
            ...
            f.write("- stt_result.json (transcript results)\n")
            f.write("- stt_health.json (server status)\n")
            f.write("- stt.log (detailed log)\n\n")
        ...
        diagnostic_path = self.test_output_dir / "stt_diag.json"
    ...
    def generate_diagnostic_report(self) -> None:
        ...
        report_path = self.test_output_dir / "stt_diag.txt"
        with open(report_path, "w", encoding="utf-8") as f:
...
async def main():
    ...
    try:
        ...
        if success:
            ...
            print("=" * 50)
            print("Test failed!")
            print("Check tests/output/stt.log for details")
            print("=" * 50)
            sys.exit(1)
